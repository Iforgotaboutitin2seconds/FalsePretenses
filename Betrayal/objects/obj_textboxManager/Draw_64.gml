if (textToWrite != "")
{
	...
	if (done = true)
	{
		if (textAction = 1)
		{
			...
			draw_sprite_ext(textboxSprite, 0, spawnX, textboxTop - 96, xScale, 0.8, 0, c_white, 1);
			...
			draw_text(textboxLeft, textboxTop - 51.2, "Option");
			draw_text(textboxLeft, textboxTop - 115.2, "Option");
		}
		else
		{
