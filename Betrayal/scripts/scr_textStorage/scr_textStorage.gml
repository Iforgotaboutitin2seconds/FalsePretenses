...
function scr_textStorage(){
	...
	knifeInspect = [
		["This knife looks like it's covered in blood. But whose blood is it....?", -1, 5, 0]
	];
	
	rockingChairInspect = [
		["An old rocking chair, slightly covered in dust. Clearly this hasn't been used in a while.", -1, 2, 0]
	];
